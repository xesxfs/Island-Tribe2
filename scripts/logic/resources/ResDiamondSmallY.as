package logic.resources
{
   ...
   public class ResDiamondSmallY extends PickupableObject
   {
       
      
      public function ResDiamondSmallY(param1:Sprite, param2:int, param3:int, param4:int, param5:String)
      {
         super(param1,param5);
         this.x = param2;
         this.y = param3;
         ...
         m_gives = param4;
         var _loc6_:Bitmap = new Bitmap(new art_res_diamond_small_y());
