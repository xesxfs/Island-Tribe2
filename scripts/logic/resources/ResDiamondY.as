package logic.resources
{
   ...
   public class ResDiamondY extends PickupableObject
   {
       
      
      private var m_anim:BmpClip = null;
      
      public function ResDiamondY(param1:Sprite, param2:int, param3:int, param4:int, param5:String)
      {
         super(param1,param5);
         this.x = param2;
         this.y = param3;
         ...
         m_gives = param4;
         this.m_anim = new BmpClip(new art_diamond_y(),1.2,12);
