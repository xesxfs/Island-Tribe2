package logic.dynamic_objects
{
   ...
   public class SawMill_Broken extends RepairableObject
   {
       
      
      public function SawMill_Broken(param1:Sprite, param2:int, param3:int, param4:String, param5:Rectangle = null)
      {
         super(param1,param4,true,6);
         this.x = param2;
         this.y = param3;
         var _loc6_:Bitmap = new Bitmap();
         _loc6_.bitmapData = new art_SawMill_Broken();
         _loc6_.x = -_loc6_.width / 2;
         _loc6_.y = -_loc6_.height / 2;
         m_broken.addChild(_loc6_);
         var _loc7_:Bitmap = new Bitmap();
         _loc7_.bitmapData = new art_SawMill();
         _loc7_.x = -_loc7_.width / 2;
         _loc7_.y = -_loc7_.height / 2;
         m_full.addChild(_loc7_);
         m_name = XMLTranslation.s("BLD_SAWMILL_BROKEN");
         m_uses = 4;
