package logic.dynamic_objects
{
   ...
   public class StoneBridgeH_Broken extends RepairableObject
   {
       
      
      public function StoneBridgeH_Broken(param1:Sprite, param2:int, param3:int, param4:Number, param5:String, param6:Rectangle = null)
      {
         ...
         _loc7_.bitmapData = new art_bridge_stone_h_broken();
         _loc7_.smoothing = true;
         var _loc8_:Bitmap = new Bitmap();
         _loc8_.bitmapData = new art_bridge_stone_h();
