package logic.dynamic_objects
{
   ...
   public class AzPyramid_2 extends RepairableObject
   {
       
      
      public function AzPyramid_2(param1:Sprite, param2:int, param3:int, param4:String, param5:Boolean = false, param6:Rectangle = null)
      {
         ...
         m_sel_r.scaleX = 1.6;
         m_sel_r.scaleY = 1.6;
         var _loc7_:Bitmap = new Bitmap(new art_pyramid_az_2());
