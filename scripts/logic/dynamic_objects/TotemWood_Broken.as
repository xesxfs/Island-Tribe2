package logic.dynamic_objects
{
   ...
   public class TotemWood_Broken extends RepairableObject
   {
       
      
      public function TotemWood_Broken(param1:Sprite, param2:int, param3:int, param4:String, param5:Rectangle = null)
      {
