package logic.dynamic_objects
{
   ...
   public class RoadHoleS extends RepairableObject
   {
       
      
      public function RoadHoleS(param1:Sprite, param2:int, param3:int, param4:String, param5:Boolean = false, param6:Rectangle = null)
      {
