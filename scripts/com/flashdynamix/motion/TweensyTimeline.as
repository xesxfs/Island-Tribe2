package com.flashdynamix.motion
{
   ...
   public class TweensyTimeline
   {
      ...
      {
         var _loc4_:AbstractTween = null;
         var _loc3_:Number = this.ease.apply(null,this.args);
         for each(_loc4_ in this.list)
         {
            if(_loc4_.instance == param1)
            {
               _loc4_.updateTo(_loc3_,param2);
            }
         }
      }
      ...
      public function stop(param1:* = null, ... rest) : void
      {
         var _loc4_:AbstractTween = null;
         var _loc5_:int = 0;
         var _loc3_:Array = param1 is Array?param1:param1 == null?null:[param1];
         _loc5_ = this._tweens - 1;
         while(_loc5_ >= 0)
         {
            _loc4_ = this.list[_loc5_];
            if(_loc3_ == null || _loc3_.indexOf(_loc4_.instance) != -1)
            {
               if(rest.length == 0)
               {
                  _loc4_.stopAll();
      ...
      public function update(param1:Number) : Boolean
      {
         ...
         var _loc2_:Number = this._time - this.delayStart;
         var _loc3_:Boolean = false;
         if(_loc2_ > 0)
         {
            _loc3_ = this.finished;
            _loc2_ = _loc2_ > this._duration?Number(this._duration):Number(_loc2_);
            this.args[0] = _loc2_;
            _loc4_ = this.ease.apply(null,this.args);
            _loc6_ = 0;
            while(_loc6_ < this._tweens)
            {
               _loc5_ = this.list[_loc6_];
            ...
            if(_loc3_)
            {
               ...
               if(_loc3_)
               {
                  ...
                  _loc3_ = this.finished && !this.canRepeat;
                  if(_loc3_ && this._onComplete != null)
                  {
                     this._onComplete();
                  }
               }
      ...
      function removeOverlap(param1:TweensyTimeline) : void
      {
         var _loc2_:int = 0;
